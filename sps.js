...
/**
 * @function sps
 * Создаёт объект, представляющий сложную позиционную систему счисления
 * @param base : Array<Number> - массив оснований разрядов системы
 * @param sep : Array<String> - массив разделителей разрядов системы
 * @param pad : Array<Number> - массив размеров полей разрядов (в символах)
 * @param post : String - строка, которая пишется после числа
 */
